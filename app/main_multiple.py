...
class CpEvent:
    ...
    def OnReceived(self):
        ...
        if (exFlag == ord('1')):  # 동시호가 시간 (예상체결)
            ...
            data = Data(code, self.today + timess, cprice, diff, cVol, vol)

            print("-----")

            kafka_producer.push("current_price", data.make_json_str(), code)
...
class MyWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        # 수정 시작, objStockCur 여러개
        # self.symbols = []
        #
        # self.objStockList = [CpStockCur() for _ in range(400)]
